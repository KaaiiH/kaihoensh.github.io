(function (factory) {
  if (typeof define === "function" && define.amd) {
    // register as an anonymous module. (that's what amd means)
  ...
  $.fn.tilt = function (options) {
    ...
    const prepareGlare = function () {
      ...
      // so I can mess with glare as I please instead of it being prerendered
      if (!glarePrerender)
        // Created glare element
        $(this).append(
